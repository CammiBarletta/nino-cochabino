...
function FormularioProducto() {
  ...
  // del contexto: agregar, editar y validar
  const { agregarProducto, editarProducto, validar } = useProducts();

  // si vengo desde "editar", acá viaja el producto
  ...
  // si estoy editando, cargo los datos iniciales
  useEffect(() => {
  ...
  const manejarEnvio = async (e) => {
    ...
    try {
      ...
      if (modo === "agregar") {
        ...
        alert(
          `Producto "${nuevoProducto.nombre}" agregado correctamente con ID: ${nuevoProducto.id}`
        );
    ...
    >
      ...
      <div style={{ marginBottom: "15px" }}>
        ...
        <input
          ...
          onChange={manejarCambio}
          disabled={cargando}
          placeholder="Ej: Muñecos, Peluches, Juegos de mesa..."
          style={{
            width: "100%",
            padding: "8px",
      ...
      <div style={{ marginBottom: "15px" }}>
        ...
        <input
          ...
          onChange={manejarCambio}
          disabled={cargando}
          placeholder="https://ejemplo.com/juguete.jpg"
          style={{
            width: "100%",
            padding: "8px",
            border: "1px solid #ccc",
